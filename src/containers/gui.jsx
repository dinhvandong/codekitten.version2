...
class GUI extends React.Component {
    ...
    componentDidMount () {
        ...
        console.log("match2",this.props.projectIdString);
        const projectIdString = this.props.projectIdString;
        const playerOnly = this.props.playerOnly;

        console.log("projectIdString",projectIdString);
        console.log("playerOnly",playerOnly);

        if(projectIdString != 'getStarted') {
            const projectIdString = this.props.projectIdString;

            this.props.onLoadingStarted();

            const link_download =
            'https://staging.teky.asia/v1/code_kittens_api/projects/' + projectIdString;
